...
\DoxyCodeLine{}
\DoxyCodeLine{\#\ Treatment\ when\ using\ the\ card}
...
\end{DoxyCode}
\hypertarget{md__2home_2debil_2Lab-work-2_2architecture_2requirements_autotoc_md6}{}\doxysection{\texorpdfstring{The AI system}{The AI system}}\label{md__2home_2debil_2Lab-work-2_2architecture_2requirements_autotoc_md6}
...
{\bfseries{Selection example\+:}} \`{}\`{} Cards in your hand\+:
\begin{DoxyItemize}
\item Fireball (cost=3, dmg=5)
\item Heal (cost=2, heal=3)
\item Shield (cost=1, armor=2)
\end{DoxyItemize}

AI Selection\+: Fireball (max. damage) \`{}\`{}\hypertarget{md__2home_2debil_2Lab-work-2_2architecture_2requirements_autotoc_md7}{}\doxysection{\texorpdfstring{Saving progress (temporarily for json example)}{Saving progress (temporarily for json example)}}\label{md__2home_2debil_2Lab-work-2_2architecture_2requirements_autotoc_md7}
{\bfseries{Saved data\+:}}
...
\end{DoxyCode}
\hypertarget{md__2home_2debil_2Lab-work-2_2architecture_2requirements_autotoc_md8}{}\doxysection{\texorpdfstring{Test scenarios}{Test scenarios}}\label{md__2home_2debil_2Lab-work-2_2architecture_2requirements_autotoc_md8}
...
\DoxyCodeLine{\ \ \ \ Tank\_Character\ tank;}
